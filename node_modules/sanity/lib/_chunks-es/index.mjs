...
function UserComponentPane(props) {
  ...
  let t3;
  $[17] !== UserComponent || $[18] !== child || $[19] !== paneKey || $[20] !== restPane || $[21] !== restProps ? (t3 = isValidElementType(UserComponent) && /* @__PURE__ */ jsx(UserComponent, __spreadProps(__spreadValues(__spreadValues({}, restProps), restPane), { ref: setRef, child, paneKey })), $[17] = UserComponent, $[18] = child, $[19] = paneKey, $[20] = restPane, $[21] = restProps, $[22] = t3) : t3 = $[22];
  let t4;
