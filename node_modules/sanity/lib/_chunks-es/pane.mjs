...
import { isValidElement, forwardRef, useContext, useId, useState, useEffect, useRef, useImperativeHandle, memo, useCallback, useMemo, useLayoutEffect, useDeferredValue, useReducer, createElement, Fragment as Fragment$1, lazy } from "react";
    ...
    $[43] !== documentTitle ? (t162 = {
      ...
      /* @__PURE__ */ jsxs(Box, { overflow: "auto", paddingTop: 2, children: [
        /* @__PURE__ */ jsxs(Table$1, { children: [
          ...
          /* @__PURE__ */ jsx("tbody", { children: crossDatasetReferences.references.filter(_temp$j).map((t172, index) => {
            const {
              projectId,
              datasetName,
              documentId
...
function PaneLayout(props) {
  ...
  const [controller] = useState(_temp$h), [rootElement, setRootElement] = useState(null), rootRect = useElementRect(rootElement), width = (rootRect == null ? void 0 : rootRect.width) || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
  ...
  let t14;
  $[32] !== children || $[33] !== restProps || $[34] !== t11 || $[35] !== t12 || $[36] !== t13 ? (t14 = /* @__PURE__ */ jsx(Root$5, __spreadProps$B(__spreadValues$H({ "data-ui": "PaneLayout" }, restProps), { "data-collapsed": t11, "data-resizing": t12, "data-mounted": t13, ref: setRootElement, children })), $[32] = children, $[33] = restProps, $[34] = t11, $[35] = t12, $[36] = t13, $[37] = t14) : t14 = $[37];
  let t15;
...
function MissingSchemaType(props) {
  ...
  let t6;
  return $[12] !== layout || $[13] !== t2 || $[14] !== t5 ? (t6 = /* @__PURE__ */ jsx(SanityDefaultPreview, { title: t2, subtitle: t5, media: _temp$f, layout }), $[12] = layout, $[13] = t2, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
}
function _temp$f() {
...
const preventDefault = (ev) => ev.preventDefault(), FormView = forwardRef(function(props, ref) {
  ...
  const {
    ...
    title
  } = useDocumentTitle(), [patchChannel] = useState(() => createPatchChannel()), isLocked = (_a = editState == null ? void 0 : editState.transactionSyncLock) == null ? void 0 : _a.enabled, {
    t
...
const KeyboardShortcutResponder = memo(function(props) {
  ...
  let t3;
  return $[18] !== As || $[19] !== children || $[20] !== handleKeyDown || $[21] !== id || $[22] !== rest || $[23] !== rootRef || $[24] !== t2 ? (t3 = /* @__PURE__ */ jsxs(As, __spreadProps$q(__spreadValues$u({ id, onKeyDown: handleKeyDown, tabIndex: -1 }, rest), { ref: rootRef, children: [
    children,
    t2
