...
function UserComponentPane(props) {
  ...
  const [ref, setRef] = React.useState(null), {
    title: t0
  } = sanity.useI18nText(pane), title = t0 === void 0 ? "" : t0, t1 = ref == null ? void 0 : ref.actionHandlers;
  let t2;
  ...
  let t3;
  $[17] !== UserComponent || $[18] !== child || $[19] !== paneKey || $[20] !== restPane || $[21] !== restProps ? (t3 = reactIs.isValidElementType(UserComponent) && /* @__PURE__ */ jsxRuntime.jsx(UserComponent, __spreadProps(__spreadValues(__spreadValues({}, restProps), restPane), { ref: setRef, child, paneKey })), $[17] = UserComponent, $[18] = child, $[19] = paneKey, $[20] = restPane, $[21] = restProps, $[22] = t3) : t3 = $[22];
  let t4;
