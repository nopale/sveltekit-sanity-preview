...
import { Card, Button, Text, Stack, Inline, Box, Flex, Container as Container$1, Code, Label, ErrorBoundary, Tooltip, TextInput, Spinner, useToast, MenuButton, Menu, Grid, Switch, MenuDivider, MenuItem, Hotkeys, usePrefersReducedMotion, TooltipDelayGroupProvider, BoundaryElementProvider } from "@sanity/ui";
import { uuid } from "@sanity/uuid";
import { useRef, useEffect, createContext, useContext, useLayoutEffect, useState, forwardRef, Suspense, memo, useId, lazy, useMemo, useCallback, createElement, useImperativeHandle, useSyncExternalStore, startTransition, useReducer } from "react";
...
const SharedStateProvider = function(props) {
  ...
  $[4] !== comlink ? (t3 = (key, value) => {
    sharedState.current[key] = value, comlink == null || comlink.post("presentation/shared-state", {
      key,
      value
    });
  }, $[4] = comlink, $[5] = t3) : t3 = $[5];
  ...
  let t4;
  $[6] !== comlink ? (t4 = (key_0) => {
    comlink == null || comlink.post("presentation/shared-state", {
      key: key_0
...
function validateWidths(panels, widthsToValidate, containerWidth) {
  ...
  if (remainingWidth.toFixed(3) !== "0.000")
    for (let index = 0; index < panels.length; index++) {
      ...
      const width = Math.min(maxWidth != null ? maxWidth : 100, Math.max(minWidth, widths[index] + remainingWidth));
...
function ErrorCard(props) {
  ...
  let t10;
  return $[34] !== restProps || $[35] !== t9 ? (t10 = /* @__PURE__ */ jsx(Card, __spreadProps$7(__spreadValues$9({ height: "fill" }, restProps), { children: t9 })), $[34] = restProps, $[35] = t9, $[36] = t10) : t10 = $[36], t10;
}
...
const BackLink = forwardRef(function(props, ref) {
  ...
  let t2;
  return $[7] !== ref || $[8] !== restProps || $[9] !== t1 ? (t2 = /* @__PURE__ */ jsx(StateLink, __spreadProps$6(__spreadValues$8({}, restProps), { ref, state: t1, title: void 0 })), $[7] = ref, $[8] = restProps, $[9] = t1, $[10] = t2) : t2 = $[10], t2;
  ...
  let t2;
  return $[11] !== ref || $[12] !== restProps || $[13] !== t1 ? (t2 = /* @__PURE__ */ jsx(StateLink, __spreadProps$6(__spreadValues$8({}, restProps), { ref, state: t1, title: void 0 })), $[11] = ref, $[12] = restProps, $[13] = t1, $[14] = t2) : t2 = $[14], t2;
});
function PresentationPaneRouterProvider(props) {
  ...
  $[8] !== refs || $[9] !== searchParams ? (t6 = (childLinkProps) => {
    const _a = childLinkProps, {
      ...
      "childId"
    ]), ref = refs == null ? void 0 : refs.find((r) => r._id === childId || getPublishedId(r._id) === childId);
    return ref ? /* @__PURE__ */ jsx(StateLink, __spreadProps$6(__spreadValues$8({}, restProps), { state: {
      id: childId,
      type: ref._type,
      _searchParams: Object.entries(searchParams)
    } })) : /* @__PURE__ */ jsx("div", __spreadValues$8({}, restProps));
  }, $[8] = refs, $[9] = searchParams, $[10] = t6) : t6 = $[10];
  let t7, t8;
  $[11] !== searchParams ? (t7 = (backLinkProps) => /* @__PURE__ */ jsx(BackLink, __spreadProps$6(__spreadValues$8({}, backLinkProps), { searchParams })), t8 = (childLinkProps_0) => /* @__PURE__ */ jsx(ReferenceChildLink, __spreadProps$6(__spreadValues$8({}, childLinkProps_0), { searchParams })), $[11] = searchParams, $[12] = t7, $[13] = t8) : (t7 = $[12], t8 = $[13]);
  let t9;
...
function ContentEditor(props) {
  ...
  $[0] !== ((_a = mainDocumentState == null ? void 0 : mainDocumentState.document) == null ? void 0 : _a._id) || $[1] !== ((_b = mainDocumentState == null ? void 0 : mainDocumentState.document) == null ? void 0 : _b._type) || $[2] !== searchParams ? (t0 = (props_0) => {
    var _a2, _b2;
    return /* @__PURE__ */ jsx(StateLink, __spreadProps$5(__spreadValues$7({}, props_0), { state: {
  ...
  bb0: {
    ...
    let t8;
    $[15] !== schemaType2 || $[16] !== t52 || $[17] !== t7 ? (t8 = /* @__PURE__ */ jsx(SanityDefaultPreview, __spreadProps$5(__spreadValues$7({}, t52), { schemaType: schemaType2, status: t7 })), $[15] = schemaType2, $[16] = t52, $[17] = t7, $[18] = t8) : t8 = $[18], t3 = t8;
  }
  const preview = t3;
...
function usePresentationNavigator(props) {
  ...
  $[2] !== navigatorEnabled || $[3] !== unstable_navigator ? (t1 = function() {
    return /* @__PURE__ */ jsx(Fragment, { children: navigatorEnabled && /* @__PURE__ */ jsx(Navigator, __spreadValues$6({}, unstable_navigator)) });
...
const PreviewLocationInput = function(props) {
  ...
  const $ = c(27), {
    ...
    basePath: t2
  } = ((_a = useActiveWorkspace()) == null ? void 0 : _a.activeWorkspace) || {}, basePath = t2 === void 0 ? "/" : t2, inputRef = useRef(null), [sessionValue, setSessionValue] = useState(void 0), [customValidity, setCustomValidity] = useState(void 0);
  let t3;
...
`, MotionSpinner = motion.create(Spinner), MotionText = motion.create(Text), MotionMonogram = motion.create(StyledSanityMonogram), SharePreviewMenu = memo(function(props) {
  ...
  const handleUnableToToggle = useCallback(() => {
    ...
    try {
      setDisabling(!0), await disablePreviewAccessSharing(client, "@sanity/presentation", typeof window > "u" ? "" : location.href, currentUser == null ? void 0 : currentUser.id), setSecret(null);
    } catch (error_0) {
      setError(error_0);
    } finally {
      setDisabling(!1);
    }
  }, [client, currentUser == null ? void 0 : currentUser.id]), handleEnableSharing = useCallback(async () => {
    try {
      setEnabling(!0);
  ...
  }, [client, currentUser == null ? void 0 : currentUser.id]), handleCopyUrl = useCallback(() => {
    try {
      if (!url)
...
const PERSPECTIVE_TITLE_KEY = {
  ...
  let t0;
  $[0] !== props ? (t0 = (_a = props.options) != null && _a.component ? createElement(props.options.component, __spreadProps$3(__spreadValues$4({}, props), {
    renderDefault
...
function usePresentationPreviewHeader(props) {
  const $ = c(2);
  let t0;
  return $[0] !== props ? (t0 = () => /* @__PURE__ */ jsx(PreviewHeader, __spreadValues$4({}, props)), $[0] = props, $[1] = t0) : t0 = $[1], t0;
}
...
const MotionFlex = motion.create(Flex), Preview = memo(forwardRef(function(props, forwardedRef) {
  const {
    ...
    devMode
  } = usePresentationTool(), prefersReducedMotion = usePrefersReducedMotion(), ref = useRef(null), PreviewHeader2 = usePresentationPreviewHeader(__spreadProps$2(__spreadValues$3({}, props), {
    iframeRef: ref,
    options: header
  }));
  ...
  return useEffect(() => {
    ...
    /* @__PURE__ */ jsx(Card, { flex: 1, tone: "transparent", children: /* @__PURE__ */ jsxs(Flex, { align: "center", height: "fill", justify: "center", padding: (canUseViewTransition ? currentViewport : viewport) === "desktop" ? 0 : 2, sizing: "border", style: {
      ...
      showOverlaysConnectionStatus && !continueAnyway ? /* @__PURE__ */ jsx(MotionFlex, { initial: "initial", animate: "animate", exit: "exit", variants: spinnerVariants, justify: "center", align: "center", style: {
        ...
        zIndex: 1
      }, children: /* @__PURE__ */ jsxs(Flex, { style: __spreadValues$3({}, sizes[viewport]), justify: "center", align: "center", direction: "column", gap: 4, children: [
...
function useDocumentsOnPage(perspective, frameStateRef) {
  ...
  const [published, setPublished] = useState({}), [previewDrafts, setPreviewDrafts] = useState({}), urlRef = useRef(""), setDocumentsOnPage = useCallback((key, perspective_0, sourceDocuments = []) => {
    ...
    (perspective_0 === "published" ? setPublished : setPreviewDrafts)((cache) => {
      ...
      return isEqual(prev, next) ? cache : __spreadProps$1(__spreadValues$2({}, cache), {
        [key]: next
      });
    });
  }, [frameStateRef]);
...
function usePreviewUrl(previewUrl, toolName, studioPreviewPerspective, previewSearchParam, canCreateUrlPreviewSecrets) {
  ...
  const client = useClient({
    apiVersion: API_VERSION
  }), workspace = useActiveWorkspace(), basePath = ((_a = workspace == null ? void 0 : workspace.activeWorkspace) == null ? void 0 : _a.basePath) || "/", workspaceName = ((_b = workspace == null ? void 0 : workspace.activeWorkspace) == null ? void 0 : _b.name) || "default", deps = useSuspendCacheKeys(toolName, basePath, workspaceName, previewSearchParam), previewUrlSecret = usePreviewUrlSecret(canCreateUrlPreviewSecrets && typeof previewUrl == "object" || typeof previewUrl == "function", deps);
...
function usePreviewUrlSecret(enabled, deps) {
  ...
  return $[7] !== previewUrlSecret ? (t2 = () => {
    ...
    return () => clearTimeout(timeout);
  }, t3 = [previewUrlSecret], $[7] = previewUrlSecret, $[8] = t2, $[9] = t3) : (t2 = $[8], t3 = $[9]), useEffect(t2, t3), (previewUrlSecret == null ? void 0 : previewUrlSecret.secret) || null;
}
function useStatus() {
  const $ = c(4);
  let t0;
...
function PresentationTool(props) {
  ...
  const {
    ...
    canUseSharedPreviewAccess,
    tool
  } = props, components = (_a = tool.options) == null ? void 0 : _a.components, _previewUrl = (_b = tool.options) == null ? void 0 : _b.previewUrl, name = tool.name || DEFAULT_TOOL_NAME, {
    unstable_navigator,
    unstable_header
  } = components || {}, {
  ...
  const toggleOverlay = useCallback(() => visualEditingComlink == null ? void 0 : visualEditingComlink.post("presentation/toggle-overlay"), [visualEditingComlink]), [displayedDocument, setDisplayedDocument] = useState(null);
  useEffect(() => {
    const handleKeyUp = (e) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(Suspense, { children: [
      ...
      visualEditingComlink && /* @__PURE__ */ jsx(PostMessageFeatures, { comlink: visualEditingComlink }),
...
function PresentationToolGrantsCheck(props) {
  ...
  let t7;
  return $[11] !== props || $[12] !== t4 || $[13] !== t5 || $[14] !== t6 ? (t7 = /* @__PURE__ */ jsx(PresentationTool, __spreadProps(__spreadValues({}, props), { canCreateUrlPreviewSecrets: t4, canToggleSharePreviewAccess: t5, canUseSharedPreviewAccess: t6 })), $[11] = props, $[12] = t4, $[13] = t5, $[14] = t6, $[15] = t7) : t7 = $[15], t7;
}
