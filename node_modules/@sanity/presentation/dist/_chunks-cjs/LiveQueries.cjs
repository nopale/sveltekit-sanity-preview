...
var isEqual__default = /* @__PURE__ */ _interopDefaultCompat(isEqual), __defProp = Object.defineProperty, __defProps = Object.defineProperties, __getOwnPropDescs = Object.getOwnPropertyDescriptors, __getOwnPropSymbols = Object.getOwnPropertySymbols, __hasOwnProp = Object.prototype.hasOwnProperty, __propIsEnum = Object.prototype.propertyIsEnumerable, __defNormalProp = (obj, key, value) => key in obj ? __defProp(obj, key, { enumerable: !0, configurable: !0, writable: !0, value }) : obj[key] = value, __spreadValues = (a, b) => {
  for (var prop in b || (b = {}))
...
function useQuerySubscription(props) {
  ...
  const [revalidate, startRefresh] = hooks.useRevalidate(t0), shouldRefetch = revalidate === "refresh" || revalidate === "inflight" || lastLiveEventId !== (snapshot == null ? void 0 : snapshot.lastLiveEventId);
  let t1, t2;
  $[1] !== client2 || $[2] !== lastLiveEventId || $[3] !== params || $[4] !== perspective || $[5] !== query || $[6] !== shouldRefetch || $[7] !== startRefresh ? (t1 = () => {
    ...
    const controller = new AbortController(), effect = async function() {
      ...
      fetching = !1, signal.aborted || (setSnapshot((prev) => ({
        result: isEqual__default.default(prev == null ? void 0 : prev.result, result) ? prev == null ? void 0 : prev.result : result,
        resultSourceMap: isEqual__default.default(prev == null ? void 0 : prev.resultSourceMap, resultSourceMap) ? prev == null ? void 0 : prev.resultSourceMap : resultSourceMap,
        syncTags: isEqual__default.default(prev == null ? void 0 : prev.syncTags, syncTags) ? prev == null ? void 0 : prev.syncTags : syncTags,
        lastLiveEventId
      })), fulfilled = !0);
  ...
  return csm.applySourceDocuments(
    ...
    (sourceDocument) => {
      if (
        ...
        !sourceDocument._projectId && liveDocument != null && liveDocument._id && csm.getPublishedId(liveDocument._id) === csm.getPublishedId(sourceDocument._id)
      )
        return liveDocument;
    },
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
