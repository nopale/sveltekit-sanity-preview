...
function PostMessageRefreshMutationsInner(props) {
  ...
  $[0] !== comlink || $[1] !== draft || $[2] !== livePreviewEnabled || $[3] !== (prevDraft == null ? void 0 : prevDraft._rev) || $[4] !== (prevPublished == null ? void 0 : prevPublished._rev) || $[5] !== published ? (t0 = () => {
    (prevDraft == null ? void 0 : prevDraft._rev) !== (draft == null ? void 0 : draft._rev) && (react.startTransition(() => setPrevDraft(draft)), draft && (comlink == null || comlink.post("presentation/refresh", {
      source: "mutation",
      livePreviewEnabled,
      document: parseDocument(draft)
    }))), (prevPublished == null ? void 0 : prevPublished._rev) !== (published == null ? void 0 : published._rev) && (react.startTransition(() => setPrevPublished(published)), published && (comlink == null || comlink.post("presentation/refresh", {
      source: "mutation",
      livePreviewEnabled,
