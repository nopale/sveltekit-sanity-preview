"use strict";
var jsxRuntime = require("react/jsx-runtime"), framerMotion = require("framer-motion"), react = require("react"), __defProp = Object.defineProperty, __defNormalProp = (obj, key, value) => key in obj ? __defProp(obj, key, { enumerable: !0, configurable: !0, writable: !0, value }) : obj[key] = value, __publicField = (obj, key, value) => __defNormalProp(obj, typeof key != "symbol" ? key + "" : key, value);
/**
...
function QRCodeSVGComponent(props) {
  const {
    ...
    logoSize,
    size
  }), cellsToDraw = react.useMemo(() => logoSize && calculatedImageSettings != null && calculatedImageSettings.excavation ? excavateModules(cells, calculatedImageSettings.excavation) : cells, [calculatedImageSettings == null ? void 0 : calculatedImageSettings.excavation, cells, logoSize]), fgPath = generatePath(cellsToDraw, margin);
