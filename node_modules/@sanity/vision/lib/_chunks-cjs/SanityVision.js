...
function VisionCodeMirror(props) {
  ...
  let t0;
  return $[0] !== props || $[1] !== theme ? (t0 = /* @__PURE__ */ jsxRuntime.jsx(EditorRoot, { children: /* @__PURE__ */ jsxRuntime.jsx(CodeMirror__default.default, __spreadValues$5({ basicSetup: !1, theme, extensions: codemirrorExtensions }, props)) }), $[0] = props, $[1] = theme, $[2] = t0) : t0 = $[2], t0;
}
...
function VisionContainer(props) {
  ...
  const datasets = t0;
  let t1;
  return $[4] !== datasets || $[5] !== props || $[6] !== t || $[7] !== toast ? (t1 = /* @__PURE__ */ jsxRuntime.jsx(VisionGui, __spreadProps(__spreadValues$1({}, props), { datasets, toast, t })), $[4] = datasets, $[5] = props, $[6] = t, $[7] = toast, $[8] = t1) : t1 = $[8], t1;
}
